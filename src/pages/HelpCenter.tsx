...
const faqs = [
  { q: "How does Resume2Interview generate questions?", a: "We use a multi-step AI pipeline. First, your PDF resume is parsed with spaCy NLP to extract your skills, experience level, and target role. Then a generative AI model crafts unique technical interview questions specific to your claimed expertise." },
  { q: "How is my answer evaluated?", a: "Your spoken (or typed) response is sent to our AI evaluation, which scores it on technical accuracy (0–100), provides natural language feedback, and lists specific strengths and improvements related to your answer." },
      ...
      <PageHeader
        ...
        action={
          <div className="flex items-center gap-2 text-sm text-muted-foreground border border-border rounded-lg px-4 py-2 bg-surface">
            ...
            <a href="mailto:shashankyerragunta22@gmail.com" className="text-primary hover:underline">shashankyerragunta22@gmail.com</a>
          </div>
        }
      />
